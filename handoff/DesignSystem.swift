...
// MARK: - BrandCard
// Card blanca con borde sutil. Reemplaza a .glassCard() en las vistas refactorizadas.
...
// MARK: - SectionLabel
// Caption en mayúsculas con tracking, para "PRODUCTOS · 4", "TOTALES", etc.
...
// Botón pill pequeño para acciones dentro de una card (PDF, Facturar).
...
// MARK: - BigCTAButton
// Botón ancho para acción principal (Registrar pago, Iniciar servicio).
...
// Card navy oscura para sección "Totales" en factura.
